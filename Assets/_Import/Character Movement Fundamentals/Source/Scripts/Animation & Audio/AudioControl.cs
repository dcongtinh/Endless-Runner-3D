    ...
    public class AudioControl : MonoBehaviour
    {
        ...
        void FootStepUpdate(float _movementSpeed)
        {
            ...
            if (useAnimationBasedFootsteps)
            {
                ...
                float _newFootStepValue = 0.2f; // animator.GetFloat("FootStep");
        ...
        {
            //Play jump audio clip;
            audioSource.PlayOneShot(coinClip, audioClipVolume);
        }

        public void PlayDeathSound()
        {
            //Play jump audio clip;
            audioSource.PlayOneShot(deathClip, audioClipVolume);
        }
    }
}
